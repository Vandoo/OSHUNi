...
//          Calculate G for low momentum cells 
			...
			//--- e-i
            valarray<double>  IF0, IF2, Jm1, P0, S0;
            double G0(const int& n,const valarray<double>& fin);

        public:
//          Constructors/Destructors
            EE_isotropic_conserva(valarray<double>& fslope, valarray<double>& fin_e); 
...
//--------------------------------------------------------------
        public:
//          Constructor
            RungeKutta4_ee(valarray<double>& fin, int tout_start, valarray<double>& fin_e);
...
//--------------------------------------------------------------
        public:
//          Constructors/Destructors
            Explicit_EC_FP(Stat& Yin, int tout_start, Stat& Yin_e); 
...
//          Calculate the coefficients
            void reset_coeff(const valarray<double>& f00, const double Delta_t, const valarray<double>& fe0);
...
//          Advance
            Stat& f1_loop(Stat& Yin, const double Dt, Stat& Yin_e);  
            Stat& f1_loop1D(Stat& Yin, const double Dt, Stat& Yin_e);  
            Stat& flm_loop(Stat& Yin, const double Dt, Stat& Yin_e);  
            Stat& flm_loop1D(Stat& Yin, const double Dt, Stat& Yin_e);  
...
//--------------------------------------------------------------
        public:
//          Constructors/Destructors
            Euler_Backward(Stat& Yin, int tout_start, Stat& Yin_e);
