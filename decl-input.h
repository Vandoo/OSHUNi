...
//          Algorithms
            ...
            int restart_time;  int n_restarts;                  //WHY?
...
//          Output
            ...
            bool o_Vx, o_VxVx, o_Vy, o_VxVy, o_VyVy, o_Vz, o_VxVz, o_VyVz, o_VzVz;
            bool o_Vsq, o_Qx, o_Qy;
            bool o_Pressure, o_Temperature, o_ND, o_Nu, o_p1x1;
            bool only_output;
			size_t o_pmulti, o_fsp;
...
//      External electric field + magnetic field+ F_diff
            bool ex_electric, ex_magnetic;
			bool initial_x_vel, initial_y_vel, initial_x_sh;
			double Pe_ratio, T_gamma, mass_ratio;

//          density initialization
            bool setup_poly_x, setup_exp_x, setup_gauss_dens_x, setup_gauss_dens_y;
            
            bool setup_pcwise_lin_x, setup_pcwise_lin_y, setup_sine_dens_x;
            ...
            size_t smooth_x;                                    //WHY? use 0.25*( U(i-1)+2U(i)+U(i+1) ) smooth_x times, but don't know how many I need
