...
//          Boundaries 
            ...
            void mirror_bound_Yright(Stat& Y);
			// --- e-i
            void smooth_bound_Xleft(Stat& Y);
            void smooth_bound_Xright(Stat& Y);
            void contin_bound_Xleft(Stat& Y);
            void contin_bound_Xright(Stat& Y);
...
//          Boundaries for single-node configurations
            ...
            void sameNode_mirror_Y(Stat& Y);
			// --- e-i
            void sameNode_smooth_X(Stat& Y);
            void sameNode_contin_X(Stat& Y);
            complex<double>   idx;
            size_t            szy;
...
//          parallel current, uses Ampere's Law
            void parallel_Jamp(size_t step, Stat& Y);
            void parallel_Jv(size_t step, Stat& Y);
...
//          Conversion to cartesian grid
            ...
            void parallel_pdistr_1p(size_t step, Stat& Y);
...
//          Restart files                                       //WHY? already have n_out 
            int restart_time;
            int restart_step;
        };
//--------------------------------------------------------------
