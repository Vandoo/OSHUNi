...
//**************************************************************
//--------------------------------------------------------------
        class External_EBfield{
//--------------------------------------------------------------
//      Decleration of the Phenomenological Laser Source 
//--------------------------------------------------------------
        public:
//          Constructors/Destructors
            External_EBfield(Stat& Yin, int tout_start); 
         
//          Explicit Advance
            void EB_field(const double& tnew);    

//          Temporal Evolution
            //double t_Profile(const double& t2); 
            double Carrier_Signal(const double& phase); 
            double Carrier_Signal_cos(const double& phase); 
...
//          Laser polarization
        ...
        private:
            ...
            const double rise_time, fall_time, flat_time;
            const double vos, omega_0, omega_p, w0overwp;
            const bool   ex_electric, ex_magnetic; 
        };
//--------------------------------------------------------------
//**************************************************************
