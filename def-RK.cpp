...
//**************************************************************
//--------------------------------------------------------------
    Runge_Kutta_4::Runge_Kutta_4(Stat& Yin, int tout_start, Stat& Yin_e, Parallel_Environment& PE)
//--------------------------------------------------------------
//  Constructor
//--------------------------------------------------------------
...
/*        switch (operation) {
       ...
       CX.Neighbor_Communications(Yslope);
       return Act.Adv(Yslope, Ye);
...
//      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
//      New Step: Ampere -> J, save in Ye.E
        CX.Neighbor_Communications(Y);
		E_Act.Adv_Ohm(Y, Ye);
...
//**************************************************************
//--------------------------------------------------------------
    Runge_Kutta_3::Runge_Kutta_3(Stat& Yin, int tout_start, Stat& Yin_e, Parallel_Environment& PE)
//--------------------------------------------------------------
//  Constructor
//--------------------------------------------------------------
       :t(static_cast<double>(tout_start) *
...
//**************************************************************
//--------------------------------------------------------------
    Runge_Kutta_2::Runge_Kutta_2(Stat& Yin, int tout_start, Stat& Yin_e,Parallel_Environment& PE)
//--------------------------------------------------------------
//  Constructor
//--------------------------------------------------------------
       :t(static_cast<double>(tout_start) *
...
//--------------------------------------------------------------
//  Take a step using RK2                                       //WHY- Heun's Method
//--------------------------------------------------------------
...
//**************************************************************
//--------------------------------------------------------------
    Runge_Kutta_2_Imp::Runge_Kutta_2_Imp(Stat& Yin, int tout_start, Stat& Ye, Parallel_Environment& PE)
//--------------------------------------------------------------
//  Constructor
//--------------------------------------------------------------
       :t(static_cast<double>(tout_start) *
...
//  Call Advection Actions 
    Stat& Runge_Kutta_2_Imp::F1(Stat& Yslope) {
        CX.Neighbor_ImplicitE_Communications(Yslope);
